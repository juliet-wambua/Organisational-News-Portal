...
public class Sql2oDepartmentsDaoTest {
    ...
    public void  addDptToEmployees() {
        Employees employees = new Employees("kaparro", "Senior Chef", "Cooks","biggie");
        employeesDao.add(employees);
        Employees employees2 = new Employees("kaparro", "Senior Chef", "Cooks","biggie");
    ...
    public Departments setupDepartments(){
        return new Departments("sales", "marketing", 40);
    }
