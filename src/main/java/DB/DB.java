...
public class DB {
    ...
    private static String testConnectionString = "jdbc:postgresql://localhost:5432/organizational_news_portal_test";
    private static String testUsers = "moringaschool";
